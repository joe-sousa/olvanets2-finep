...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-O2', '-g', '-fwrapv', '-O3']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-O2', '-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-O2', '-g', '-fwrapv', '-O3']
...
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_SIGNAL_H': '', 'HAVE_SYS_TYPES_H': '', 'PYTHONDIR': '', 'INT64X64_USE_128': '', 'HAVE_DIRENT_H': '', 'HAVE_STDINT_H': '', 'HAVE_SQLITE3': '', 'HAVE_LIBXML2': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_PYEXT': '', 'HAVE_GSL': '', 'HAVE_SYS_STAT_H': '', 'HAVE_PACKET_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_STDLIB_H': '', 'HAVE_PTHREAD_H': '', 'HAVE___UINT128_T': '', 'HAVE_PYEMBED': '', 'PYTHONARCHDIR': '', 'HAVE_GETENV': '', 'HAVE_RT': '', 'HAVE_IF_TUN_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_UINT128_T': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['traffic-control', 'udp', 'energy', 'tutorial', 'udp-client-server', 'error-model', 'naming', 'wireless', 'ipv6', 'matrix-topology', 'realtime', 'socket', 'stats', 'routing', 'tcp']
...
LIBPATH_PYEMBED = ['/usr/local/lib/python2.7/config']
LIBPATH_PYEXT = ['/usr/local/lib/python2.7/config']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_GSL = ['gsl', 'gslcblas', 'm']
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['python2.7', 'dl', 'm', 'python2.7', 'dl', 'm']
LIB_PYEXT = ['python2.7', 'dl', 'm', 'python2.7', 'dl', 'm']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
...
cfg_files = ['/home/alisson/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/alisson/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
