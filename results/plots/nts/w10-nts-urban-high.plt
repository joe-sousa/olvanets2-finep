...
plot "../../dat/nts-urban-high-random2.dat" using ($1-6.3):($2+$3+$4) notitle w boxes ls 1 fs so 0.5,\
...
"../../dat/nts-urban-high-hvc.dat" using ($1-3.1):($2+$3+$4) notitle w boxes ls 3 fs so 0.5,\
...
"../../dat/nts-urban-high-mdo.dat" using ($1):($2+$3+$4) notitle w boxes ls 9 fs so 0.5,\
...
"../../dat/nts-urban-high-gtt.dat" using ($1+3.1):($2+$3+$4) notitle w boxes ls 5 fs so 0.5,\
"" using ($1+3.1):($2+$3+$4) notitle w boxes lc 0 fs pa 5 trans,\
"" using ($1+3.1):($2+$3) notitle w boxes ls 5 fs so 0.5,\
"" using ($1+3.1):($2) notitle w boxes ls 5 fs so 0.5,\
"" using ($1+3.1):($2) notitle w boxes lc 0 fs pa 2 trans,\
"../../dat/nts-urban-high-abc.dat" using ($1+6.3):($2+$3+$4) notitle w boxes ls 7 fs so 0.5,\
"" using ($1+6.3):($2+$3+$4) notitle w boxes lc 0 fs pa 5 trans,\
