...
#set xtics ("4" 0, "8" 20, "12" 40, "4" 60, "8" 80, "12" 100)
#set xtics ("{/Helvetica-Italic T_1/Ha" 0, "{/Helvetica-Italic T_2/Ha" 20, "{/Helvetica-Italic T_3/Ha" 40, "{/Helvetica-Italic T_1/Fu" 60, "{/Helvetica-Italic T_2/Fu" 80, "{/Helvetica-Italic T_3/Fu" 100)
...
#set xlabel "Workload/Coverage"
#set xlabel "-------------------------   -------------------------\nHalf Coverage                                    Full Coverage\nWorkload"
...
"../../dat/nts-highway-high-hvc.dat" using ($1-2.0):($2+$3+$4) notitle w boxes ls 3 fs so 0.5,\
"" using ($1-2.0):($2+$3+$4) notitle w boxes lc 0 fs pa 5 trans,\
"" using ($1-2.0):($2+$3) notitle w boxes ls 3 fs so 0.5,\
"" using ($1-2.0):($2) notitle w boxes ls 3 fs so 0.5,\
"" using ($1-2.0):($2) notitle w boxes lc 0 fs pa 2 trans,\
"../../dat/nts-highway-high-gtt.dat" using ($1+2.0):($2+$3+$4) notitle w boxes ls 5 fs so 0.5,\
"" using ($1+2.0):($2+$3+$4) notitle w boxes lc 0 fs pa 5 trans,\
"" using ($1+2.0):($2+$3) notitle w boxes ls 5 fs so 0.5,\
"" using ($1+2.0):($2) notitle w boxes ls 5 fs so 0.5,\
"" using ($1+2.0):($2) notitle w boxes lc 0 fs pa 2 trans,\
"../../dat/nts-highway-high-abc.dat" using ($1+6.0):($2+$3+$4) notitle w boxes ls 7 fs so 0.5,\
"" using ($1+6.0):($2+$3+$4) notitle w boxes lc 0 fs pa 5 trans,\
"" using ($1+6.0):($2+$3) notitle w boxes ls 7 fs so 0.5,\
"" using ($1+6.0):($2) notitle w boxes ls 7 fs so 0.5,\
"" using ($1+6.0):($2) notitle w boxes lc 0 fs pa 2 trans,\
...
8 / 0 title "BCV" with boxes linestyle 7 fs so 0.5
