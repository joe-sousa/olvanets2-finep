...
#set xtics ("4H" 0, "8H" 20, "12H" 40, "4F" 60, "8F" 80, "12F" 100)  
...
"../../dat/nts-highway-medium-hvc.dat" using ($1-2.0):($2+$3+$4) notitle w boxes ls 3 fs so 0.5,\
...
"../../dat/nts-highway-medium-gtt.dat" using ($1+2.0):($2+$3+$4) notitle w boxes ls 5 fs so 0.5,\
"" using ($1+2.0):($2+$3+$4) notitle w boxes lc 0 fs pa 5 trans,\
"" using ($1+2.0):($2+$3) notitle w boxes ls 5 fs so 0.5,\
"" using ($1+2.0):($2) notitle w boxes ls 5 fs so 0.5,\
"" using ($1+2.0):($2) notitle w boxes lc 0 fs pa 2 trans,\
"../../dat/nts-highway-medium-abc.dat" using ($1+6.0):($2+$3+$4) notitle w boxes ls 7 fs so 0.5,\
"" using ($1+6.0):($2+$3+$4) notitle w boxes lc 0 fs pa 5 trans,\
