...
plot "../../dat/range/range-urban-16.700000-w10-gtt.dat" using ($1-2.5):($2):($3) notitle w boxerrorbars ls 11 fs so 0.5 bo 0,\
"../../dat/range/range-urban-22.350000-w10-gtt.dat" using ($1):($2):($3) notitle w boxerrorbars ls 12 fs so 0.5 bo 0,\
"../../dat/range/range-urban-28.550000-w10-gtt.dat" using ($1+2.5):($2):($3) notitle w boxerrorbars ls 13 fs so 0.5 bo 0,\
