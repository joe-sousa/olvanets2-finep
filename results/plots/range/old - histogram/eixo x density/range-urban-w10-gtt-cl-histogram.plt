...
set xtics ("Low" 0, "Medium" 15, "High" 30)
#set tics font ", 18"
set ytics 5 scale 0
set tics nomirror
...
1 / 0 title "250" w boxes ls 11 fs so 0.5 bo 0,\
3 / 0 title "500" with boxes ls 12 fs so 0.5 bo 0,\
5 / 0 title "750" with boxes ls 13 fs so 0.5 bo 0
