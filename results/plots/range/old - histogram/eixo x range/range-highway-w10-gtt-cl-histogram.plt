...
plot "../../dat/range/range-highway-low-w10-gtt.dat" using ($1-2.5):($2):($3) notitle w boxerrorbars ls 11 fs so 0.5 bo 0,\
"../../dat/range/range-highway-medium-w10-gtt.dat" using ($1):($2):($3) notitle w boxerrorbars ls 12 fs so 0.5 bo 0,\
"../../dat/range/range-highway-high-w10-gtt.dat" using ($1+2.5):($2):($3) notitle w boxerrorbars ls 13 fs so 0.5 bo 0,\
