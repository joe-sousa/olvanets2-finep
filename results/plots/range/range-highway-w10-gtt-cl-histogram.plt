...
set xtics ("{/Helvetica-Italic D_{low}" 0, "{/Helvetica-Italic D_{medium}" 15, "{/Helvetica-Italic D_{high}" 30)
#set tics font ", 18"
set ytics 5 scale 0
set tics nomirror
...
set output 'range-highway-w10-gtt-cl.eps'
set xlabel "Vehicular Density"
...
plot "../../dat/range/range-highway-16.700000-w10-gtt.dat" using ($1-2.5):($2):($3) notitle w boxerrorbars ls 11 fs so 0.5 bo 0,\
"../../dat/range/range-highway-22.350000-w10-gtt.dat" using ($1):($2):($3) notitle w boxerrorbars ls 12 fs so 0.5 bo 0,\
"../../dat/range/range-highway-28.550000-w10-gtt.dat" using ($1+2.5):($2):($3) notitle w boxerrorbars ls 13 fs so 0.5 bo 0,\
1 / 0 title "250 m" w boxes ls 11 fs so 0.5 bo 0,\
3 / 0 title "500 m" with boxes ls 12 fs so 0.5 bo 0,\
5 / 0 title "750 m" with boxes ls 13 fs so 0.5 bo 0
