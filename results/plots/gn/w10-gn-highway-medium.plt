...
"../../dat/gn-highway-medium-mdo.dat" using ($1):($2):($3) notitle w boxerrorbars ls 9 fs so 0.5,\
"../../dat/gn-highway-medium-gtt.dat" using ($1+3.0):($2):($3) notitle w boxerrorbars ls 5 fs so 0.5,\
"../../dat/gn-highway-medium-abc.dat" using ($1+6.0):($2):($3) notitle w boxerrorbars ls 7 fs so 0.5,\
