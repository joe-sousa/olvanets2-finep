...
"../../dat/gn-highway-medium-hvc.dat" using ($1-2.0):($2):($3) notitle w boxerrorbars ls 3 fs so 0.5,\
"../../dat/gn-highway-medium-gtt.dat" using ($1+2.0):($2):($3) notitle w boxerrorbars ls 5 fs so 0.5,\
