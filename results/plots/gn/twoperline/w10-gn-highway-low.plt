...
"../../dat/gn-highway-low-hvc.dat" using ($1-2.0):($2):($3) notitle w boxerrorbars ls 3 fs so 0.5,\
"../../dat/gn-highway-low-gtt.dat" using ($1+2.0):($2):($3) notitle w boxerrorbars ls 5 fs so 0.5,\
"../../dat/gn-highway-low-abc.dat" using ($1+6.0):($2):($3) notitle w boxerrorbars ls 7 fs so 0.5,\
