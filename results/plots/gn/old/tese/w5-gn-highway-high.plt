...
#set xtics ("4" 0, "6" 20, "8" 40, "10" 60, "12" 80)
...
set output 'w5-gn-highway-high.eps'
...
plot "../../dat/gn-highway-high-random2.dat" using ($1-6.0):($2):($3) notitle w boxerrorbars ls 1 fs so 0.5,\
"../../dat/gn-highway-high-hvc.dat" using ($1-3.0):($2):($3) notitle w boxerrorbars ls 3 fs so 0.5,\
"../../dat/gn-highway-high-gcf2.dat" using ($1+0.0):($2):($3) notitle w boxerrorbars ls 5 fs so 0.5,\
"../../dat/gn-highway-high-gtt.dat" using ($1+3.0):($2):($3) notitle w boxerrorbars ls 7 fs so 0.5,\
"../../dat/gn-highway-high-abc.dat" using ($1+6.0):($2):($3) notitle w boxerrorbars ls 9 fs so 0.5,\
