...
set output 'w5-gn-highway-low.eps'
set xlabel "Workload"
...
plot "../../dat/gn-highway-low-random2.dat" using ($1-6.0):($2):($3) notitle w boxerrorbars ls 1 fs so 0.5,\
"../../dat/gn-highway-low-hvc.dat" using ($1-3.0):($2):($3) notitle w boxerrorbars ls 3 fs so 0.5,\
"../../dat/gn-highway-low-gcf2.dat" using ($1+0.0):($2):($3) notitle w boxerrorbars ls 5 fs so 0.5,\
"../../dat/gn-highway-low-gtt.dat" using ($1+3.0):($2):($3) notitle w boxerrorbars ls 7 fs so 0.5,\
"../../dat/gn-highway-low-abc.dat" using ($1+6.0):($2):($3) notitle w boxerrorbars ls 9 fs so 0.5,\
