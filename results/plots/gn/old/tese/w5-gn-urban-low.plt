...
set output 'w5-gn-urban-low.eps'
set xlabel "Workload"
...
"../../dat/gn-urban-low-gcf2.dat" using ($1+0.0):($2):($3) notitle w boxerrorbars ls 5 fs so 0.5,\
"../../dat/gn-urban-low-gtt.dat" using ($1+3.0):($2):($3) notitle w boxerrorbars ls 7 fs so 0.5,\
"../../dat/gn-urban-low-abc.dat" using ($1+6.0):($2):($3) notitle w boxerrorbars ls 9 fs so 0.5,\
