...
set output 'w5-gn-urban-high.eps'
set xlabel "Workload"
...
plot "../../dat/gn-urban-high-random2.dat" using ($1-6.0):($2):($3) notitle w boxerrorbars ls 1 fs so 0.5,\
"../../dat/gn-urban-high-hvc.dat" using ($1-3.0):($2):($3) notitle w boxerrorbars ls 3 fs so 0.5,\
"../../dat/gn-urban-high-gcf2.dat" using ($1+0.0):($2):($3) notitle w boxerrorbars ls 5 fs so 0.5,\
"../../dat/gn-urban-high-gtt.dat" using ($1+3.0):($2):($3) notitle w boxerrorbars ls 7 fs so 0.5,\
"../../dat/gn-urban-high-abc.dat" using ($1+6.0):($2):($3) notitle w boxerrorbars ls 9 fs so 0.5,\
