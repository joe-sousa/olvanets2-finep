...
#set term 'pdf'
set output 'kr-urban-servers-cl.eps'
set xlabel "Vehicles with Known Routes (%)"
#set ylabel "Reduction in the Percentage of\n Recoveries by Server (%)"
set ylabel "Reduction of Recoveries by Server (%)"
...
plot "../../dat/kr/kr-urban-low-gtt.dat" using 1:4 notitle w linespoints ls 11,\
"../../dat/kr/kr-urban-medium-gtt.dat" using 1:4 notitle w linespoints ls 12,\
"../../dat/kr/kr-urban-high-gtt.dat" using 1:4 notitle w linespoints ls 13,\
"../../dat/kr/kr-urban-low-abc.dat" using 1:4 notitle w linespoints ls 14,\
"../../dat/kr/kr-urban-medium-abc.dat" using 1:4 notitle w linespoints ls 15,\
"../../dat/kr/kr-urban-high-abc.dat" using 1:4 notitle w linespoints ls 16,\
1 / 0 title "GTT Low" w linespoints ls 11,\
2 / 0 title "GTT Medium" w linespoints ls 12,\
3 / 0 title "GTT High" w linespoints ls 13,\
