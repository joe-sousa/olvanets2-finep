...
plot "../../dat/ecv/ecv-urban-random2.dat" using ($1-0.315):($2) notitle w boxes ls 1 fs so 0.5,\
"../../dat/ecv/ecv-urban-hvc.dat" using ($1-0.105):($2) notitle w boxes ls 3 fs so 0.5,\
"../../dat/ecv/ecv-urban-gtt.dat" using ($1+0.105):($2) notitle w boxes ls 5 fs so 0.5,\
"../../dat/ecv/ecv-urban-abc.dat" using ($1+0.315):($2) notitle w boxes ls 7 fs so 0.5,\
