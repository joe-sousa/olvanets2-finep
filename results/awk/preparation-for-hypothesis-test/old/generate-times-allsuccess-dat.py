...
for a in ["times-allsuccess"]:  #times: pega os tempos nos casos de sucesso
        ...
        for c in ["low","medium","high"]: #densidade
    	    for d in ["50half", "50interleaved", "100"]: #cobertura celular
                for e in ["558000", "1200000"]: #tamanho do pacote
                    ...
                    if(d=="100"):
                        cov="F"                                                        
                    os.system('awk -f times-allsuccess.awk ../../plots/dat/hyp-test/junction-'+b+'-'+c+'-'+d+'-'+e+'.temp >> ../../plots/dat/hyp-test/'+a+'-'+b+'-'+den+'-'+cov+'-'+e+'.csv')
